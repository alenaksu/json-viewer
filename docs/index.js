...
var s = class {
    ...
    get styleSheet() {
        ...
        return (
            t && e3 === void 0 && (n.set(this.cssText, (e3 = new CSSStyleSheet())), e3.replaceSync(this.cssText)), e3
        );
    }
    toString() {
        return this.cssText;
...
var i = (e3, n4) => {
    t
        ? (e3.adoptedStyleSheets = n4.map((t3) => (t3 instanceof CSSStyleSheet ? t3 : t3.styleSheet)))
        : n4.forEach((t3) => {
              const n5 = document.createElement('style'),
                  s2 = window.litNonce;
              s2 !== void 0 && n5.setAttribute('nonce', s2), (n5.textContent = t3.cssText), e3.appendChild(n5);
          });
};
var S = t
    ? (t3) => t3
    : (t3) =>
          t3 instanceof CSSStyleSheet
              ? ((t4) => {
                    let e3 = '';
                    for (const n4 of t4.cssRules) e3 += n4.cssText;
                    return o(e3);
                })(t3)
              : t3;
/**
...
var a = class extends HTMLElement {
    ...
    static get observedAttributes() {
        ...
        const t3 = [];
        return (
            this.elementProperties.forEach((i3, s2) => {
    ...
    static createProperty(t3, i3 = l) {
        if (
            ...
            const s2 = typeof t3 == 'symbol' ? Symbol() : '__' + t3,
                e3 = this.getPropertyDescriptor(t3, s2, i3);
    ...
    static finalize() {
        ...
        if (
            ...
            const t4 = this.properties,
                i3 = [...Object.getOwnPropertyNames(t4), ...Object.getOwnPropertySymbols(t4)];
            for (const s2 of i3) this.createProperty(s2, t4[s2]);
        }
    ...
    static finalizeStyles(i3) {
        ...
        if (Array.isArray(i3)) {
            ...
            for (const i4 of e3) s2.unshift(S(i4));
        } else i3 !== void 0 && s2.push(S(i3));
        return s2;
    }
    static _$Eh(t3, i3) {
    ...
    o() {
        ...
        (this._$Ep = new Promise((t4) => (this.enableUpdating = t4))),
            ...
            this._$Em(),
            this.requestUpdate(),
            (t3 = this.constructor.l) === null || t3 === void 0 || t3.forEach((t4) => t4(this));
    }
    addController(t3) {
        var i3, s2;
        ((i3 = this._$Eg) !== null && i3 !== void 0 ? i3 : (this._$Eg = [])).push(t3),
    ...
    _$ES(t3, i3, s2 = l) {
        ...
        if (h2 !== void 0 && s2.reflect === true) {
            const n4 = (
                (r2 = (e3 = s2.converter) === null || e3 === void 0 ? void 0 : e3.toAttribute) !== null && r2 !== void 0
                    ? r2
                    : o$1.toAttribute
            )(i3, s2.type);
            (this._$Ei = t3), n4 == null ? this.removeAttribute(h2) : this.setAttribute(h2, n4), (this._$Ei = null);
        }
    }
    _$AK(t3, i3) {
        var s2, e3, r2;
        const h2 = this.constructor,
            n4 = h2._$Eu.get(t3);
        if (n4 !== void 0 && this._$Ei !== n4) {
            const t4 = h2.getPropertyOptions(n4),
                l2 = t4.converter,
                a2 =
                    (r2 =
                        (e3 = (s2 = l2) === null || s2 === void 0 ? void 0 : s2.fromAttribute) !== null && e3 !== void 0
                            ? e3
                            : typeof l2 == 'function'
                            ? l2
                            : null) !== null && r2 !== void 0
                        ? r2
                        : o$1.fromAttribute;
            (this._$Ei = n4), (this[n4] = a2(i3, t4.type)), (this._$Ei = null);
        }
    }
    requestUpdate(t3, i3, s2) {
        let e3 = true;
        t3 !== void 0 &&
            (((s2 = s2 || this.constructor.getPropertyOptions(t3)).hasChanged || n$1)(this[t3], i3)
                ? (this._$AL.has(t3) || this._$AL.set(t3, i3),
                  s2.reflect === true &&
                      this._$Ei !== t3 &&
                      (this._$EC === void 0 && (this._$EC = new Map()), this._$EC.set(t3, s2)))
                : (e3 = false)),
            !this.isUpdatePending && e3 && (this._$Ep = this._$E_());
    }
    async _$E_() {
    ...
    update(t3) {
        this._$EC !== void 0 && (this._$EC.forEach((t4, i3) => this._$ES(i3, this[i3], t4)), (this._$EC = void 0)),
            this._$EU();
    }
    updated(t3) {}
    firstUpdated(t3) {}
...
(a.finalized = true),
    ...
    ((s$1 = globalThis.reactiveElementVersions) !== null && s$1 !== void 0
        ? s$1
...
var x = (t3, i3, s2) => {
    var e3, o2;
    const n4 = (e3 = s2 == null ? void 0 : s2.renderBefore) !== null && e3 !== void 0 ? e3 : i3;
    let l2 = n4._$litPart$;
    if (l2 === void 0) {
        const t4 = (o2 = s2 == null ? void 0 : s2.renderBefore) !== null && o2 !== void 0 ? o2 : null;
        n4._$litPart$ = l2 = new N(i3.insertBefore(h$1(), t4), t4, void 0, s2 != null ? s2 : {});
    }
    ...
    for (let i4 = 0; i4 < o2; i4++) {
        ...
        r2 +=
            d2 === c
                ? s2 + n$2
                : p2 >= 0
                ? (l2.push(o3), s2.slice(0, p2) + '$lit$' + s2.slice(p2) + e$2 + y)
                : s2 + e$2 + (p2 === -2 ? (l2.push(void 0), i4) : y);
    }
...
var E = class {
    constructor({ strings: t3, _$litType$: s2 }, n4) {
        ...
        const u2 = t3.length - 1,
            c2 = this.parts,
            [v2, a2] = C(t3, s2);
        if (((this.el = E.createElement(v2, n4)), (A.currentNode = this.el.content), s2 === 2)) {
        ...
        for (; (l2 = A.nextNode()) !== null && c2.length < u2; ) {
            if (l2.nodeType === 1) {
                if (l2.hasAttributes()) {
                    ...
                    for (const i3 of l2.getAttributeNames())
                        if (i3.endsWith('$lit$') || i3.startsWith(e$2)) {
                            ...
                            if ((t4.push(i3), s3 !== void 0)) {
                                const t5 = l2.getAttribute(s3.toLowerCase() + '$lit$').split(e$2),
                                    i4 = /([.?@])?(.*)/.exec(s3);
                                c2.push({
                                    type: 1,
                                    index: r2,
                    ...
                    for (const i3 of t4) l2.removeAttribute(i3);
                }
                if (g.test(l2.tagName)) {
                    const t4 = l2.textContent.split(e$2),
                        s3 = t4.length - 1;
                    if (s3 > 0) {
...
function P(t3, i3, s2 = t3, e3) {
    ...
    return (
        (d2 == null ? void 0 : d2.constructor) !== u2 &&
            ((n4 = d2 == null ? void 0 : d2._$AO) === null || n4 === void 0 || n4.call(d2, false),
            u2 === void 0 ? (d2 = void 0) : ((d2 = new u2(t3)), d2._$AT(t3, s2, e3)),
            e3 !== void 0
                ? (((l2 = (h2 = s2)._$Cl) !== null && l2 !== void 0 ? l2 : (h2._$Cl = []))[e3] = d2)
                : (s2._$Cu = d2)),
        d2 !== void 0 && (i3 = P(t3, d2._$AS(t3, i3.values), d2, e3)),
        i3
    );
}
var V = class {
    ...
    p(t3) {
        ...
        const {
            ...
            o2 = ((i3 = t3 == null ? void 0 : t3.creationScope) !== null && i3 !== void 0 ? i3 : l$1).importNode(
                s2,
                true
            );
        A.currentNode = o2;
        ...
        for (; d2 !== void 0; ) {
            if (h2 === d2.index) {
                let i4;
                d2.type === 2
                    ? (i4 = new N(n4, n4.nextSibling, this, t3))
                    : d2.type === 1
                    ? (i4 = new d2.ctor(n4, d2.name, d2.strings, this, t3))
                    : d2.type === 6 && (i4 = new L(n4, this, t3)),
                    this.v.push(i4),
                    (d2 = e3[++r2]);
            }
            h2 !== (d2 == null ? void 0 : d2.index) && ((n4 = A.nextNode()), h2++);
        }
        return o2;
    }
    m(t3) {
        ...
        for (const s2 of this.v)
            s2 !== void 0 &&
                (s2.strings !== void 0 ? (s2._$AI(t3, s2, i3), (i3 += s2.strings.length - 2)) : s2._$AI(t3[i3])),
                i3++;
    }
};
var N = class {
    constructor(t3, i3, s2, e3) {
        ...
        (this.type = 2),
            ...
            (this._$AM = s2),
            (this.options = e3),
            (this._$Cg = (o2 = e3 == null ? void 0 : e3.isConnected) === null || o2 === void 0 || o2);
    }
    get _$AU() {
        var t3, i3;
        return (i3 = (t3 = this._$AM) === null || t3 === void 0 ? void 0 : t3._$AU) !== null && i3 !== void 0
            ? i3
            : this._$Cg;
    }
    get parentNode() {
    ...
    $(t3) {
        this._$AH !== w && r$2(this._$AH) ? (this._$AA.nextSibling.data = t3) : this.k(l$1.createTextNode(t3)),
            (this._$AH = t3);
    }
    T(t3) {
        var i3;
        const { values: s2, _$litType$: e3 } = t3,
            o2 =
                typeof e3 == 'number'
                    ? this._$AC(t3)
                    : (e3.el === void 0 && (e3.el = E.createElement(e3.h, this.options)), e3);
        if (((i3 = this._$AH) === null || i3 === void 0 ? void 0 : i3._$AD) === o2) this._$AH.m(s2);
        else {
            const t4 = new V(o2, this),
                i4 = t4.p(this.options);
    ...
    S(t3) {
        ...
        let s2,
            e3 = 0;
        for (const o2 of t3)
            e3 === i3.length ? i3.push((s2 = new N(this.M(h$1()), this.M(h$1()), this, this.options))) : (s2 = i3[e3]),
                s2._$AI(o2),
                e3++;
...
var S$1 = class {
    constructor(t3, i3, s2, e3, o2) {
        (this.type = 1),
            ...
            s2.length > 2 || s2[0] !== '' || s2[1] !== ''
                ? ((this._$AH = Array(s2.length - 1).fill(new String())), (this.strings = s2))
                : (this._$AH = w);
    }
    get tagName() {
    ...
    _$AI(t3, i3 = this, s2, e3) {
        ...
        let n4 = false;
        if (o2 === void 0)
            (t3 = P(this, t3, i3, 0)), (n4 = !r$2(t3) || (t3 !== this._$AH && t3 !== b)), n4 && (this._$AH = t3);
        else {
            const e4 = t3;
            let l2, h2;
            for (t3 = o2[0], l2 = 0; l2 < o2.length - 1; l2++)
                (h2 = P(this, e4[s2 + l2], i3, l2)),
                    h2 === b && (h2 = this._$AH[l2]),
                    n4 || (n4 = !r$2(h2) || h2 !== this._$AH[l2]),
                    h2 === w ? (t3 = w) : t3 !== w && (t3 += (h2 != null ? h2 : '') + o2[l2 + 1]),
                    (this._$AH[l2] = h2);
        }
        n4 && !e3 && this.C(t3);
    }
...
var I = class extends S$1 {
    ...
    _$AI(t3, i3 = this) {
        var s2;
        if ((t3 = (s2 = P(this, t3, i3, 0)) !== null && s2 !== void 0 ? s2 : w) === b) return;
        const e3 = this._$AH,
            o2 =
                (t3 === w && e3 !== w) || t3.capture !== e3.capture || t3.once !== e3.once || t3.passive !== e3.passive,
            n4 = t3 !== w && (e3 === w || o2);
        o2 && this.element.removeEventListener(this.name, this, e3),
            n4 && this.element.addEventListener(this.name, this, t3),
            (this._$AH = t3);
    }
    handleEvent(t3) {
        var i3, s2;
        typeof this._$AH == 'function'
            ? this._$AH.call(
                  (s2 = (i3 = this.options) === null || i3 === void 0 ? void 0 : i3.host) !== null && s2 !== void 0
                      ? s2
                      : this.element,
                  t3
              )
...
z == null || z(E, N),
    ((t$1 = globalThis.litHtmlVersions) !== null && t$1 !== void 0 ? t$1 : (globalThis.litHtmlVersions = [])).push(
        '2.2.6'
    );
/**
 * @license
...
var s$3 = class extends a {
    ...
    createRenderRoot() {
        ...
        return (
            ((t3 = (e3 = this.renderOptions).renderBefore) !== null && t3 !== void 0) ||
                (e3.renderBefore = i3.firstChild),
            i3
        );
    }
    update(t3) {
...
(s$3.finalized = true),
    (s$3._$litElement$ = true),
    (l$2 = globalThis.litElementHydrateSupport) === null ||
        l$2 === void 0 ||
        l$2.call(globalThis, {
            LitElement: s$3
        });
...
((o$3 = globalThis.litElementVersions) !== null && o$3 !== void 0 ? o$3 : (globalThis.litElementVersions = [])).push(
    '3.2.0'
);
 ...
 */
var i2 = (i3, e3) =>
    e3.kind === 'method' && e3.descriptor && !('value' in e3.descriptor)
        ? {
              ...e3,
              finisher(n4) {
                  n4.createProperty(e3.key, i3);
              }
          }
        : {
              kind: 'field',
...
function e2(e3) {
    return (n4, t3) =>
        t3 !== void 0
            ? ((i3, e4, n5) => {
                  e4.constructor.createProperty(n5, i3);
              })(e3, n4, t3)
            : i2(e3, n4);
}
/**
...
var n2;
var e$12 =
    ((n2 = window.HTMLSlotElement) === null || n2 === void 0 ? void 0 : n2.prototype.assignedElements) != null
        ? (o2, n4) => o2.assignedElements(n4)
        : (o2, n4) => o2.assignedNodes(n4).filter((o3) => o3.nodeType === Node.ELEMENT_NODE);

// docs/_snowpack/pkg/lit/directives/when.js
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
function n3(n4, o2, r2) {
    return n4 ? o2() : r2 == null ? void 0 : r2();
}
        ...
        decorateElement: function (element, placements) {
            ...
            for (var decorators = element.decorators, i3 = decorators.length - 1; i3 >= 0; i3--) {
                ...
                var elementFinisherExtras = this.toElementFinisherExtras(
                    (0, decorators[i3])(elementObject) || elementObject
                );
                ...
                if (elementsAndFinisher.elements !== void 0) {
                    ...
                    for (var j = 0; j < elements.length - 1; j++) {
                        for (var k2 = j + 1; k2 < elements.length; k2++) {
                            if (
                                elements[j].key === elements[k2].key &&
                                elements[j].placement === elements[k2].placement
                            ) {
...
function _unsupportedIterableToArray(o2, minLen) {
    ...
    if (n4 === 'Object' && o2.constructor) n4 = o2.constructor.name;
    if (n4 === 'Map' || n4 === 'Set') return Array.from(o2);
    if (n4 === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n4)) return _arrayLikeToArray(o2, minLen);
}
        ...
        `;
                ...
                },
                {
                    ...
                    value: function renderNodePreview(node) {
                        return $` <span class="preview"> ${generateNodePreview(node)} </span> `;
                    }
                },
                {
                    kind: 'method',
                    key: 'renderPropertyKey',
                    value: function renderPropertyKey({ isCollapsable, collapsed, onClick, key }) {
                        return $`
            <span
                ...
                },
                {
                    ...
                    value: function renderValue(node, path) {
                        ...
                        const value = isNode(node)
                            ? node
                            : $` <span tabindex="0" class=${getType(node)}>${JSON.stringify(node)}</span> `;
                        return highlight2 !== null && path === highlight2 ? $`<mark>${value}</mark>` : value;
                    }
                },
                {
                    kind: 'method',
                    ...
                    value: function render() {
                        ...
                        return $` ${n3(isDefined(data), () => this.renderNode(data))} `;
                    }
                }
            ]
        };
...
filter2.addEventListener('change', () => {
    if (!filter2.value) viewer.resetFilter();
    else viewer.filter(filter2.value);
});
